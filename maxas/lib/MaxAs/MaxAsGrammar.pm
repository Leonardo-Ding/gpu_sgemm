...
my $r8h     = qr"(?<r8negh>\-)?(?<r8abs>\|)?(?<r8>$reg)\|?(?:\.(?<r8part>H0|H1|B0|B1|B2|B3|H0_H0|H1_H1|F32))?(?<reuse1>\.reuse)?";
...
(
    ...
    LEA       => [
                   ...
                   { type => $shftT,  code => 0x5bdf004000000000, rule => qr"^$pred?LEA\.HI$X $r0cc, $r8h, $r20, $r39, $i28w8;"o,          },
                   { type => $shftT,  code => 0x0a07000000000000, rule => qr"^$pred?LEA\.HI$X $r0cc, $r8h, $c20, $r39, $i51w5;"o,          },
                 ],
#    LEA.HI    => [ { type => $shftT,  code => 0x5bdf004000000000, rule => qr"^$pred?LEA\.HI$X $r0cc, $r8, $r20, $r39, $i28w8;"o,          } ],
    ...
    P2R    => [ { type => $x32T,  code => 0x38e8000000000000, rule => qr"^$pred?P2R$b1 $r0, PR, $r8, $i20w8;"o,   } ],
    #P2R.B1 => [ { type => $x32T,  code => 0x38e8020000000000, rule => qr"^$pred?P2R\.B1 $r0, PR, $r8, $i20w7;"o,   } ],
    R2P    => [ { type => $shftT, code => 0x38f0000000000000, rule => qr"^$pred?R2P PR, $r8, $i20w8;"o,   } ],
...
0x0000200000000000 r8neg
0x0000002000000000 r8negh
...
sub genCode
{
    ...
    #print "inst:    $grammar->{rule}";

    #print $op, "\n";
    #print $flags, "\n";
    #if ($op eq 'LEA') {
    #    print "this inst is LEA\n";
    #    print $flags, "\n";
    #    my $rrule = $grammar->{rule};
    #    print " LEA:    $grammar->{code}\n";
    #}
    #print "$immedCode \n";
    #print "$test \n";
